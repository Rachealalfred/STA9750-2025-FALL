...
As Netflix continues its mission to produce “gourmet cheeseburgers” — high-quality content with mass appeal — understanding viewership patterns becomes crucial.
...
```
The TV show **`r run_show`** stayed **`r run_weeks`** weeks in **`r run_country`**’s Top 10.
...
```
**`r debut_show`** debuted in **`r debut_country_count`** countries — the widest launch.
